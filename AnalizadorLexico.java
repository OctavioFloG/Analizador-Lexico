    ...
    public void procesarArchivo(String nombreArchivo) {
        try {
            ...
            while ((caracter = fr.read()) != -1) {
                ...
                // Si no hay transición válida, termina el procesamiento
                if (nuevoEstado == null) {
                    System.out.println("Transición inválida en estado: " + estadoActual);
                    fr.close();
                    return;
                }
